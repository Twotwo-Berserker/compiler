        ...
        while (look != '%') {
            if (look == '*') {
                ...
                if (t == 0) {// is basic before *
                    ...
                    System.out.println("not a legal regex!(It must be basic characters or ')' before *)");
                    return null;
                }
                stack.push(knode);
            }
            ...
            else if (Character.isDigit(look) || Character.isLetter(look) || look == 'ε') {
